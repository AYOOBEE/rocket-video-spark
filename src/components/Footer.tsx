...
const Footer = () => {
  return (
    <footer className="bg-gray-900/70 border-t border-white/10 pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Newsletter */}
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <h3 className="text-2xl font-bold text-white mb-4">Stay Updated</h3>
          <p className="text-gray-300 mb-6">
            Subscribe to our newsletter for the latest updates, AI video creation tips, and special offers
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            />
            <Button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 px-6">
              Subscribe
            </Button>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              AI-powered video creation platform that turns text prompts into professional videos
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-purple-400 transition-colors">Use Cases</a></li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-500 text-center">
            © {new Date().getFullYear()} RocketVideosAI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
